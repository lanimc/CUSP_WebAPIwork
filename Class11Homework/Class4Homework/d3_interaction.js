var app = {
    ...
    parseBeerData: function(theBeers){
        ...
        var node = svg.append("g")
            ...
            .data(theBeers)
                ...
                .call(d3.drag()
                    ...
                    .on("drag", dragged)
                    .on("end", dragended))
                .on("click", function(d) { d3.select(".draw text").remove(); return d3.select(".draw").append("text").text(d.name);})
                .on("dblclick",function(d) { app.getFoodData(d.style.description);});
